...
class CoreDataStackTests_Backup: DatabaseBaseTest {
    ...
    func testThatMetadataIsDeletedWhenImportingBackup() {
        ...
        directory.viewContext.setPersistentStoreMetadata("1234567890", key: ZMUser.ZMPersistedClientIdKey)
        ...
        // then
        XCTAssertNil(importedDirectory.viewContext.persistentStoreMetadata(forKey: ZMUser.ZMPersistedClientIdKey))
