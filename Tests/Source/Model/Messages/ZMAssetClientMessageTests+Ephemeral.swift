...
extension ZMAssetClientMessageTests_Ephemeral {
    ...
    func testThatItStartsATimerIfTheMessageIsAMessageOfTheOtherUser() throws {
        ...
        let uploaded = GenericMessage(content: WireProtos.Asset(withUploadedOTRKey: .randomEncryptionKey(), sha256: .zmRandomSHA256Key()), nonce: message.nonce!, expiresAfter: conversation.activeMessageDestructionTimeoutValue?.rawValue)
    ...
    func testThatItExtendsTheDeletionTimer() throws {
        ...
        // given
        self.conversation.localMessageDestructionTimeout = .tenSeconds
